    ...
    return(
        ...
        <section id="about" className=" flex flex-col justify-center h-full items-center gap-3">
            ...
            <div className="text-center bg-white max-w-md h-auto rounded-md border-black border-2 ">
                ...
                Tenetur qui fuga eligendi quidem eos odio quia reiciendis amet consequuntur natus illo autem neque voluptate nam id voluptatibus provident quo debitis doloribus praesentium explicabo, quibusdam hic! Non, tenetur laborum.
                Eligendi cupiditate mollitia voluptas perferendis corporis. Incidunt iure odit, vitae in quod natus libero voluptatibus, perspiciatis ut repellat itaque omnis quidem quam nulla numquam magnam, sequi totam harum vel perferendis.</p>
            </div>
